...
public class daoMarcas {
    ...
    private static final String SQL_INSERT = "INSERT INTO tbl_marcas(marCodigo, marNombre, marExistencias, marPrecios, marEstatus) VALUES(?, ?, ?, ?, ?)";
    ...
    public int ingresaMarcas(clsMarcas marcas) {
        ...
        try {
            ...
            stmt.setString(2, marcas.getNombreMarcas());
            stmt.setInt(3, marcas.getExistenciasMarcas());
            stmt.setDouble(4, marcas.getPreciosMarcas());
            stmt.setString(5, marcas.getEstatusMarcas());
