...
public class frmMovimientos extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        clsMovimientos mov = new clsMovimientos();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsMovimientos> listaMovimientos = mov.getListadoMovimientos();
        tablaMovimientos.setModel(modelo);
        String[] dato = new String[4];
        for (int i = 0; i < listaMovimientos.size(); i++) {
            dato[0] = Integer.toString(listaMovimientos.get(i).getMovCodigo());
            dato[1] = listaMovimientos.get(i). getMovDescripcion();
          //  dato[2] = Integer.toString(listaLineas.get(i).getExistenciasMarcas());
            dato[2] = Integer.toString(listaMovimientos.get(i).getMovEfecto());
            dato[3] = listaMovimientos.get(i).getMovEstatus();
            modelo.addRow(dato);
        }       
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(label1)
                        .addGap(294, 535, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsMovimientos mov = new clsMovimientos();
        mov.setMovCodigo(Integer.parseInt(txtbuscado.getText()));
        registrosBorrados=mov.setBorrarMovimientos(mov);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        clsMovimientos mov = new clsMovimientos();
        mov.setMovCodigo(Integer.parseInt(txtCodigo.getText()));
        mov.setMovDescripcion(txtNombre.getText());
        //marcas.setExistenciasMarcas(Integer.parseInt(txtExistencias.getText()));
        mov.setMovEfecto(Integer.parseInt(txtPrecios.getText()));
      //  marcas.setLinPrecios (txtPrecios.getText());
        mov.setMovEstatus(txtEstatus.getText());
        mov.setIngresarMovimientos(mov);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        mov.setMovCodigo(Integer.parseInt(txtbuscado.getText()));        
        mov = mov.getBuscarInformacionMovimientoPorCodigo(mov);
        System.out.println("Linea retornada:" + mov);
        txtCodigo.setText(Integer.toString(mov.getMovCodigo()));
        txtNombre.setText(mov.getMovDescripcion());
        //txtExistencias.setText(Integer.toString(marcas.getExistenciasMarcas()));
        txtPrecios.setText(Double.toString(mov.getMovEfecto()));
        txtEstatus.setText(mov.getMovEstatus());
