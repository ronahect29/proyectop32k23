...
public class frmLineas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        clsLineas marcas = new clsLineas();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsLineas> listaLineas = marcas.getListadoLineas();
        tablaLineas.setModel(modelo);
        String[] dato = new String[4];
        for (int i = 0; i < listaLineas.size(); i++) {
            dato[0] = Integer.toString(listaLineas.get(i).getLinCodigo());
            dato[1] = listaLineas.get(i). getLinNombre();
          //  dato[2] = Integer.toString(listaLineas.get(i).getExistenciasMarcas());
            dato[2] = Integer.toString(listaLineas.get(i).getLinPrecios());
            dato[3] = listaLineas.get(i).getLinEstatus();
            modelo.addRow(dato);
        }       
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        lineas.setLinCodigo(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        clsLineas lineas = new clsLineas();
        lineas.setLinCodigo(Integer.parseInt(txtCodigo.getText()));
        lineas.setLinNombre(txtNombre.getText());
        //marcas.setExistenciasMarcas(Integer.parseInt(txtExistencias.getText()));
        lineas.setLinPrecios(Integer.parseInt(txtPrecios.getText()));
      //  marcas.setLinPrecios (txtPrecios.getText());
        lineas.setLinEstatus(txtEstatus.getText());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        lineas.setLinCodigo(Integer.parseInt(txtbuscado.getText()));        
        lineas = lineas.getBuscarInformacionlineasPorCodigo(lineas);
        System.out.println("Linea retornada:" + lineas);
        txtCodigo.setText(Integer.toString(lineas.getLinCodigo()));
        txtNombre.setText(lineas.getLinNombre());
        //txtExistencias.setText(Integer.toString(marcas.getExistenciasMarcas()));
        txtPrecios.setText(Double.toString(lineas.getLinPrecios()));
        txtEstatus.setText(lineas.getLinEstatus());
...
//        // TODO add your handling code here:
        ...
        lineas.setLinCodigo(Integer.parseInt(txtbuscado.getText()));
        lineas.setLinNombre(txtNombre.getText());
       // lineas.setExistenciasMarcas(Integer.parseInt(txtExistencias.getText()));
        lineas.setLinPrecios(Integer.parseInt(txtPrecios.getText()));
        lineas.setLinEstatus(txtEstatus.getText());
