...
public class frmLineas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        clsLineas lin = new clsLineas();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsLineas> listaLineas = lin.getListadoLineas();
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsLineas lin = new clsLineas();
        lin.setlinCodigo(Integer.parseInt(txtbuscado.getText()));
        registrosBorrados=lin.setBorrarLineas(lin);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        clsLineas lin = new clsLineas();
        lin.setlinCodigo(Integer.parseInt(txtCodigo.getText()));
        lin.setlinNombre(txtNombre.getText());
        //marcas.setExistenciasMarcas(Integer.parseInt(txtExistencias.getText()));
        lin.setlinPrecios(Integer.parseInt(txtPrecios.getText()));
      //  marcas.setLinPrecios (txtPrecios.getText());
        lin.setLinEstatus(txtEstatus.getText());
        lin.setIngresarLineas(lin);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        lin.setlinCodigo(Integer.parseInt(txtbuscado.getText()));        
        lin = lin.getBuscarInformacionLineasPorCodigo(lin);
        System.out.println("Linea retornada:" + lin);
        txtCodigo.setText(Integer.toString(lin.getlinCodigo()));
        txtNombre.setText(lin.getlinNombre());
        //txtExistencias.setText(Integer.toString(marcas.getExistenciasMarcas()));
        txtPrecios.setText(Double.toString(lin.getlinPrecios()));
        txtEstatus.setText(lin.getLinEstatus());
